...
def features():
    ...
    with col2:
        if vAR_input_app == 'Language':
            ...
            vAR_use_case = ["chat-bison","chat-bison@001"]
            vAR_input_use_case = st.radio('',options=vAR_use_case,horizontal=True)
            if vAR_input_use_case == "chat-bison":
                with col1:
                    st.write("### ")
                ...
                with col2:
                    ...
                    if vAR_text_input != "":
                        ...
                        if st.button("Submit"):
                            # Calling the model
                            response_1=language_model1(vAR_text_input)
                            with cc1:
                                # Displaying the response from model
                                st.markdown(response_1)

            elif vAR_input_use_case == "chat-bison@001":
                with col1:
                    st.write("")
                    st.markdown("<p style='text-align: left; color: black; font-size:20px;'><span style='font-weight: bold'>Model Input</span></p>", unsafe_allow_html=True)
                with col2:
                    ...
                    if vAR_text_input_2 != "":
                        ...
                        if st.button("Submit"):
                            # Calling the model
                            response_2=language_model2(vAR_text_input_2)
                            with cc1:
                                # Displaying the response from model
            ...
            # Speech to text
                ...
                with col2:
                    ...
                    if audio_bytes:
                        ...
                        if st.button("Submit"):
                            # Calling the model
                            response_5=model_stt(audio_bytes)
                            with cc1:
                                # Displaying the response
